...
public interface AllMessage {
    ...
    String PASS_AND_CONF_PASS_DIFFERENT_MESSAGE = "Password and Confirm Password should be the same. Please re-enter.";
    ...
    String CATEGORY_REMOVED_FROM_TEST_MESSAGE = "The category is removed from the selected test.";
    String ARTICLE_REMOVED_MESSAGE = "The article is removed.";
    String ARTICLE_UPDATED_MESSAGE = "The article is added/updated.";
    String CATEGORY_NOT_REMOVED_MESSAGE = "The category cannot be removed - it contains questions.";
    ...
    String TEST_NOT_DELETED_MESSAGE = "The test cannot be deleted. Make sure it doesn't contain categories.";
