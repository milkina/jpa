...
<cache:cacheTag/>
    ...
    <div class="container about-items">
     	    <main>
     	     ...
     	     программных продуктов? Мы предлагаем <strong class="strong-invisible">лучший курс Java Junior</strong> для тех, кто совсем не знаком с
     	     программированием.</p>
             ...
             будет приносить не только удовлетворение, но и хорошую прибыль. Именно по этим концепциям была
              разработана <strong class="strong-invisible">бесплатная обучающая программа, чтобы стать
              ...
              <li>На <strong class="strong-invisible">языке программирования Java</strong> создают мобильные приложения, веб-сайты, облачные проекты во всех сферах и отраслях.</li>
              ...
              <p class="index-items-text">Благодаря нашим <strong class="strong-invisible">бесплатным online Java курсам</strong> вы может стать участником более чем 9-ти миллионного объединения программистов и разработчиков. Получите безграничные возможности для создания IT-продуктов и сможете заполучить работодателя из любой страны.</p>
            ...
            <ul class="row index-items">
              ...
              <li class="index-item index-item2 col-xs-12 col-sm-6 col-md-3">
                ...
                <div class="index-items-text"><strong class="strong-invisible">Видеокурсы Java для начинающих</strong> доступны людям с ограниченными временными возможностями, нет нужды тратить время на дорогу для посещения курсов.</div>
              </li>
            ...
            <p class="index-items-text"><strong class="strong-invisible">Дистанционное видео обучение Java программированию с нуля</strong> позволит переквалифицироваться без отрыва от текущей работы. Это важно для тех, кто зависит от постоянного источника дохода, имеет семью и детей.</p>
            ...
            <ul class="pig-globe row">
              ...
              <li class="learn-java-item index-image-flags col-xs-12 col-md-4">Много практики, благодаря которой вы сможете решать вполне конкретные задачи.</li>
              <li class="learn-java-item index-image-globe col-xs-12 col-md-4">Доступное изложение материала, дающее отличный старт в новой профессии.</li>
            </ul>
            <p class="index-items-text">На курсе <strong class="strong-invisible">программирования на Java для чайников с
            ...
            <p class="index-items-text">Процесс обучения на <strong class="strong-invisible">курсах Java в Украине</strong>
            ...
            <h4>Программа базового курса по Java SE:</h4>
