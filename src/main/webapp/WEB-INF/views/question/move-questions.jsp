      ...
      <div class="mainArea">
           <c:if test="${person.sysadmin}">
              ...
              <form action="${pageContext.request.contextPath}/move-batch" method="POST" id="addQuestionForm">
                 ...
                 <span class="adminLabel"><spring:message code="course"/>:</span> ${TESTS[param.TEST_PATH].name}&nbsp;
                 <span class="adminLabel"><spring:message code="category.label"/>:</span>&nbsp;<category:category categoryPath="${param.CATEGORY_PATH}">
          ...
          <span class="wrongMessage">${param.message}</span><br>
