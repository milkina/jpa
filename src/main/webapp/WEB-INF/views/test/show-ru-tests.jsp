     ...
     <jsp:body>
        ...
        <main>
          <div class="category-article">
            ...
            <p>После вы увидите свой результат в процентном и количественном выражении. Вам будут представлены списком все заданные вопросы, ваши и правильные ответы. При неудовлетворительном результате рекомендуем пройти бесплатные курс обучения на нашем сайте полностью либо изучить его отдельные уроки.</p>
            <p><strong class="strong-invisible">Вопросы для программистов на собеседовании Java</strong> в подавляющем большинстве случаев касаются следующих тем:</p>
<ul>
<li>Общие по программированию: операции и операторы, многопоточность.</li>
<li>OCAJP 8: OOP Concepts, Assignments, Strings.</li>
...
<p>Большая часть тестов — это практические задания. В одних вам придется найти ошибку, в других подставить пропущенные части либо ответить: откомпилируется ли код. Если вы правильно отвечаете на наши
 <strong class="strong-invisible">вопросы с ответами для собеседования Java Core</strong> значит, можете смело приступать к стажировке / работе в позиции Junior. Мы также рекомендуем регулярно проводить тестирование не только перед подготовкой к интервью, но и в процессе обучения.</p>
<h2>Как удачно пройти собеседование на Java Junior</h2>
<p>Составленные нами для <strong class="strong-invisible">собеседования по Java вопросы и ответы</strong> к собеседованию помогут вам подготовится к теоретическим и практическим заданиям. Однако, рекомендуем также изучите сферу деятельности компании и ее продукты.</p>
<p>Главная цель работодателя — это не столько получить правильные <strong class="strong-invisible">ответы на вопросы для собеседования по Java</strong>, а найти сотрудника, способного внести вклад в развитие его бизнеса. Соискатель должен быть активным, коммуникабельным, способным поддержать здоровую атмосферу в коллективе. Поэтому вы должны не только доказать свой профессионализм, но и понравится работодателю.</p>
...
<p>Одни люди нанимают других людей эмоционально. Если собеседник понравился, то работодатель неосознанно оправдывает свой выбор рациональными доводами. Это особенно актуально, когда задаются и выслушивают <strong class="strong-invisible">вопросы и ответы на собеседование Java Junior</strong>. К новичкам не предъявляют завышенных требований.</p>
