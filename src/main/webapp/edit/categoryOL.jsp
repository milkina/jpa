<meta property = "og:title" content = "<c:if test="${CATEGORY_ATTRIBUTE.parentCategory!=null}">${CATEGORY_ATTRIBUTE.parentCategory.name}.</c:if>${CATEGORY_ATTRIBUTE.name} - ${TESTS[param.TEST_PATH].name}" />
